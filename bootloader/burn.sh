...
avrdude_cmd="$avrdude_binary -C$avrdude_conf -pattiny85 -cusbtiny -U efuse:w:${extended_fuse}:m -U hfuse:w:${high_fuse}:m -U lfuse:w:${low_fuse}:m -U flash:w:$bootloader_hex_file"
echo $avrdude_cmd
eval $avrdude_cmd